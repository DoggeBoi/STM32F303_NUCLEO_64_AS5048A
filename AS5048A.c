...
/*   Initialisation   */
uint8_t AS5048A_Init(AS5048A *encoder, SPI_HandleTypeDef *spiHandle, GPIO_TypeDef *csPort, uint16_t csPin) {
...
void AS5048A_ReadAngle(AS5048A *encoder, uint16_t *angle){
